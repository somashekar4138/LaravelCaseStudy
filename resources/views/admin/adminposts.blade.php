...
<div class='dashboard'>
    <div class="dashboard-nav">
        ...
        <nav class="dashboard-nav-list">
          ...
          <a href="/allusers" class="dashboard-nav-item"><i class="fas fa-tachometer-alt"></i>All Users</a>
            <a href="/adminpost" class="dashboard-nav-item active"><i class="fas fa-cogs"></i> All Posts </a>
...
<table  class="t-table">
  ...
  ?>
    ...
    <tr style="height: 100px">
      ...
      <td>{{$user->Category}}</td>
      <td>{{$user->Status}}</td>
      <td><a href="/publish/{{$user->Id}}">Publish</a></td>
      <td><a href="/unpublish/{{$user->Id}}">Reject</a></td>
