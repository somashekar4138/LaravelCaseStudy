...
<form class="aaa" action="/update" method="post">
...
<?php endif; ?>
    ...
    <input class="inp" type="text" name="title" value="{{$user->Title}}">
              
<textarea class="aaa" name="body" id="output" placeholder="Enter Body" >{{$user->Description}}</textarea>
